            ...
            <CarouselContent>
              <CarouselItem>
                <Card className="pt-4">
                  <CardContent>
                    <img
                      src="../../../public/img/P2BreadBoard.png"
                      alt="Montage sur breadboard"
                      className="rounded-md w-full h-auto cursor-zoom-in"
                      onClick={() => window.open("../../../public/img/P2BreadBoard.png", "_blank")}
                    />
              ...
              <CarouselItem>
                <Card className="pt-4">
                  <CardContent>
                    <img
                      src="../../../public/img/P2Site.png"
                      alt="Interface du site web"
                      className="rounded-md w-full h-auto cursor-zoom-in"
                      onClick={() => window.open("../../../public/img/P2Site.png", "_blank")}
                    />
